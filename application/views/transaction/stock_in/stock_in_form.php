        ...
        <div class="box">
                    ...
                    <h3 class="box-title">Add Stock In</h3>
                        <div class="pull-right">
                            <a href="<?=site_url('stock/in')?>" class="btn btn-warning btn-square">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">                                
                                ...
                                <div class="form-group">
                                    <label>Detail *</label>
                                    <input type="text" name="detail" value=""  class="form-control" required>
                                </div>
                                ...
                                <div>
                                    <button type="submit" name="in_add" class="btn btn-success btn-square">
